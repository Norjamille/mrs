            ...
            <div class="hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col">
                ...
                <div class="flex flex-col flex-1 min-h-0 bg-white border-r border-gray-200">
                    <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
                        <div class="flex items-center flex-shrink-0 px-4">
                            <h1 class="text-2xl font-extrabold tracking-widest text-rose-500">
                                MRS
                            </h1>
                        </div>
                        <nav class="flex-1 px-2 mt-5 space-y-2 bg-white">
                            <Link v-for="(link, index) in navigations" :key="index" :href="link.url" :class="{
                                'bg-rose-500 text-white': $page.url.startsWith(link.url),
                                'text-gray-600 hover:bg-gray-50 hover:text-gray-900': !$page.url.startsWith(link.url),
                            }" class="flex items-center px-2 py-2 font-medium rounded-md group">
                            <component :is="link.icon" class="flex-shrink-0 w-6 h-6 mr-3" />
                            {{ link.name }}
                            </Link>
                        </nav>
                    </div>
            ...
            <div class="flex flex-col flex-1 md:pl-64">
                ...
                <main class="flex-1">
                    <div class="py-6">
                        ...
                        <div class="px-4 mx-auto mt-5 sm:px-6 md:px-8">
                            <slot />
                        </div>
                    </div>
                </main>
