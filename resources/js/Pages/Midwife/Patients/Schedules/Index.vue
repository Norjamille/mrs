            ...
            <div class="px-4 py-10 sm:px-6 lg:hidden">
                <ol
                    ...
                    <li class="flex p-4 pr-6 group focus-within:bg-gray-50 hover:bg-gray-50">
                        ...
                        <a href="#"
                            class="self-center flex-none px-3 py-2 ml-6 font-semibold text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm opacity-0 hover:bg-gray-50 focus:opacity-100 group-hover:opacity-100">Edit<span
...
const generateCalendar = () => {
    ...
    // Add empty days to fill the first row
...
let daysOfWeek = ref(['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'])
